export default function TitleBar() {
  return (
    <div
      ...
      style={{ WebkitAppRegion: "drag" }} // ⬅️ omogoči premikanje okna
    >
      ...
      <div className="flex space-x-1" style={{ WebkitAppRegion: "no-drag" }}>
        <button
          className="px-3 p-1 hover:bg-slate-700 rounded-b rounded-l text-gray-300 cursor-pointer"
          onClick={() => window.electronAPI.minimize()}
        >
          -
        </button>
        <button
          className="px-3 py-1 hover:bg-red-600  rounded-b text-gray-300 cursor-pointer"
